...
| allowedTools | 設定不需確認的工具 | CLAUDE.md frontmatter |
| 對話授權 | 這次對話的臨時授權 | 對話開頭 |
-->
...
- [Claude Code Docs — Settings](https://docs.anthropic.com/en/docs/claude-code/settings) — allowedTools 等權限設定
